...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="toolbar">
            ...
            <button class="btn-add"><i class="bi bi-plus-circle"></i> Add Branch</button>
        </div>
        ...
        <div class="table-wrap">
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    <tr>
                        <td><strong>BRO01</strong></td>
                        <td>Sta. Clara Branch</td>
                        <td>Sta. Clara, Cebu</td>
                    ...
                    <tr>
                        <td><strong>BRO02</strong></td>
                        <td>San Isidro Branch</td>
                        <td>San Isidro, City</td>
                        <td><span class="status-badge">Active</span></td>
                        <td class="action-icons">
                            <i class="bi bi-eye"></i>
                            <i class="bi bi-pencil-square"></i>
                    ...
                    <tr>
                        <td><strong>BRO03</strong></td>
                        <td>Cabantian Branch</td>
                        <td>Cabantian, City</td>
                        <td><span class="status-badge">Active</span></td>
                        <td class="action-icons">
                            <i class="bi bi-eye"></i>
                            <i class="bi bi-pencil-square"></i>
